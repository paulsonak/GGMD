...
import GGMD.generative_networks.generative_models_helpers.AutoGrow.filter.execute_filters as Filter
...
class SmilesClickChem(object):
    ...
    #def __init__(self, params, list_of_already_made_smiles): #STB
