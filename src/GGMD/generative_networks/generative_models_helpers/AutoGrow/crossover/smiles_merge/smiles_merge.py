...
import GGMD.generative_networks.generative_models_helpers.AutoGrow.crossover.smiles_merge.merge_functions.merge_w_core as MWC
import GGMD.generative_networks.generative_models_helpers.AutoGrow.crossover.smiles_merge.merge_functions.dict_and_r_groups as DnR
import GGMD.generative_networks.generative_models_helpers.AutoGrow.crossover.smiles_merge.merge_functions.alignment_and_breaks as AnB
import GGMD.generative_networks.generative_models_helpers.AutoGrow.convert_files.gypsum_dl.gypsum_dl.MolObjectHandling as MOH
...
def run_main_smiles_merge(protanate_step, max_time_mcs_thorough, min_atom_match_mcs, lig_string_1, lig_string_2):
    """
    ...
    if mcs_results.numAtoms < min_atom_match_mcs:
        return None
